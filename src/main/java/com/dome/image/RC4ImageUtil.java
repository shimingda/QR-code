...
/**
 * @author Simon
 * @create 2005-05-01 16:37
 * @desc 流加密算法，密钥长度可变，对称加密算法
 **/
public class RC4ImageUtil {
    ...
    public RC4ImageUtil() throws NoSuchAlgorithmException, NoSuchPaddingException {
    ...
    public static void main(String[] args) throws Exception {
        RC4ImageUtil de1 = new RC4ImageUtil();
        ...
        for (int i=0;i<10000;i++){
            ...
            String path1="C:\\Users\\Administrator\\Desktop\\文档\\image\\person\\7\\"+uuid.toString()+".jpg";
...
//        byte[] decontent = de1.Decryptor(encontent);
        ...
        File file2 = new File("C:\\Users\\Administrator\\Desktop\\文档\\image\\person\\7");
        File[] files= file2.listFiles();
        List<File> fileList= Arrays.asList(files);
        for (File f:fileList) {
            UUID uuid=    UUID.randomUUID();
            String path1="C:\\Users\\Administrator\\Desktop\\文档\\image\\person\\77\\"+uuid.toString()+".jpg";
...
//            f.delete();
//        }
//        String path3="C:\\Users\\Administrator\\Desktop\\文档\\image\\person\\2";
